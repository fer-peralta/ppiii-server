...
export class MongoManager {
    ...
    async saveData(data) {
        try {
            ...
            logError.error({ message: `There was an error saving the document`, error: error })
    ...
    async getAll() {
        try {
            ...
            logError.error({ message: `There was an error getting the documents`, error: error })
            return { message: `There was an error getting the documents`, error: error }
        }
    }
    ...
    async getById(id) {
        try {
            ...
            logError.error({ message: `There was an error searching the document`, id: id, error: error })
            return { message: `There was an error searching the document`, id: id, error: error }
        }
    }
    ...
    async updateById(id, body) {
        try {
            ...
            logError.error({ message: `There was an error updating the document`, id: id, error: error })
            return { message: `There was an error updating the document`, id: id, error: error }
        }
    }
